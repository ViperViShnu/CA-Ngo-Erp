<form role="form" enctype="multipart/form-data" id="form"
      action="<?php echo base_url(); ?>admin/report/asset_report" method="post" class="form-horizontal  ">
        ...
        <div class="panel panel-custom">
            ...
            <div class="panel-heading">
                <div class="panel-title">
                    <strong><?= lang('asset_report') ?></strong>

                    <?php
                    if (!empty($all_transaction_info)):
                        ?>
                        <div class="pull-right hidden-print">
                            <a href="<?php echo base_url() ?>admin/report/asset_report_pdf/<?= date('Y-m-d', strtotime($start_date)) . '/' . date('Y-m-d', strtotime($end_date)) ?>"
